...
export default function NavBar() {
  ...
  return (
    <nav className="w-full flex flex-col px-3 gap-1">
      <NavLink
        to={"/"}
        className={`hover:bg-[#343437] ${
          (pathname === "/" || pathname.includes("/")) && "bg-[#343437]"
        } ${
          pathname === "/library" ? "bg-transparent" : "bg-[#343437]"
        } flex items-center gap-2 rounded-lg p-[17px] w-full `}
      >
        <svg
      ...
      <NavLink
        to={"/library"}
        className={`hover:bg-[#343437] flex items-center ${
          pathname === "/library" && "bg-[#343437]"
        } gap-2 rounded-lg p-[17px] w-full `}
      >
        <svg
          className="w-6 h-6 text-gray-800 dark:text-white"
          aria-hidden="true"
